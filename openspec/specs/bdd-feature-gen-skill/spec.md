# BDD Feature Gen Skill

## Purpose

Define the architecture, communication protocol, and operational behavior of the `bdd-feature-gen` skill — a sidecar process that provides real-time step catalog access to the LLM agent for generating BDD feature files with high step reuse.
