...
Define the behavior of the `audit_step_reuse.py` tool that detects step reuse by comparing newly generated feature files against the Step Index, producing reuse metrics, optimization suggestions, and CI-gateable exit codes.
